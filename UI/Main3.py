...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def disable_window(self,val):
        self.actionViewBook.setVisible(val)
        self.actionWatch.setVisible(val)

    def disable_ifempty(self):
        if Controller.control.rCarte.cr == [] and Controller.control.rClient.cl == [] and Controller.control.rImprumut.im == []:
            self.disable(self.Search,True)
            self.disable(self.Statistics,True)
            self.disable(self.bx.change_button,True)
            self.disable(self.bx.delete_button,True)
            self.bx.select_line.hide()
            self.bx.stackedWidget.setCurrentIndex(1)
            self.bx.modify_widget.hide()
            self.disable_window(False)
    ...
    def new(self):
        ...
        Controller.control.idbook=1
        Controller.control.idclient=1
        Controller.control.identry=1
...
""))
        ...
        self.MainPhoto.setGeometry(QtCore.QRect(390, 30, 80, 67))
        self.MainPhoto.setStyleSheet(_fromUtf8(""))
        self.MainPhoto.setText(_fromUtf8(""))
        self.MainPhoto.setPixmap(QtGui.QPixmap(_fromUtf8("UI/logo.png")))
     ...
     QMenuBar::item {
        ...
        QtCore.QObject.connect(self.actionOpen, QtCore.SIGNAL(_fromUtf8("triggered()")), lambda:self.disable_window(True))


        QtCore.QObject.connect(self.actionNew, QtCore.SIGNAL(_fromUtf8("triggered()")), lambda:self.disable(self.Search,True))
        QtCore.QObject.connect(self.actionNew, QtCore.SIGNAL(_fromUtf8("triggered()")), lambda:self.disable(self.Statistics,True))
        QtCore.QObject.connect(self.actionNew, QtCore.SIGNAL(_fromUtf8("triggered()")), lambda:self.disable(self.bx.change_button,True))
        QtCore.QObject.connect(self.actionNew, QtCore.SIGNAL(_fromUtf8("triggered()")), lambda:self.disable(self.bx.delete_button,True))
        QtCore.QObject.connect(self.actionNew, QtCore.SIGNAL(_fromUtf8("triggered()")), lambda:self.disable_window(False))



        self.bx.done_button1.clicked.connect(lambda:self.disable(self.Search,False))
        self.bx.done_button1.clicked.connect(lambda:self.disable(self.Statistics,False))
        self.bx.done_button1.clicked.connect(lambda:self.disable(self.bx.change_button,False))
        self.bx.done_button1.clicked.connect(lambda:self.disable(self.bx.delete_button,False))
        self.bx.done_button1.clicked.connect(lambda:self.disable_window(True))



        self.bx.done_button2.clicked.connect(lambda:self.disable(self.Search,False))
        self.bx.done_button2.clicked.connect(lambda:self.disable(self.Statistics,False))
        self.bx.done_button2.clicked.connect(lambda:self.disable(self.bx.change_button,False))
        self.bx.done_button2.clicked.connect(lambda:self.disable(self.bx.delete_button,False))
        self.bx.done_button2.clicked.connect(lambda:self.disable_window(True))


        self.bx.done_button3.clicked.connect(lambda:self.disable(self.Search,False))
        self.bx.done_button3.clicked.connect(lambda:self.disable(self.Statistics,False))
        self.bx.done_button3.clicked.connect(lambda:self.disable(self.bx.change_button,False))
        self.bx.done_button3.clicked.connect(lambda:self.disable(self.bx.delete_button,False))
        self.bx.done_button3.clicked.connect(lambda:self.disable_window(True))


        self.bx.done_button7.clicked.connect(self.disable_ifempty)
        self.bx.done_button8.clicked.connect(self.disable_ifempty)
        self.bx.done_button9.clicked.connect(self.disable_ifempty)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionWatch.setText(_translate("MainWindow", "Data Viewer", None))
